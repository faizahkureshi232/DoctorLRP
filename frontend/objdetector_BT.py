...
class BT_ObjectDetector:
    def __init__(self):
        self.model_path="/home/hackathon/frontend/best_tumor.pt" #brain turmor yolo model path
        self.model = YOLO(self.model_path)
        self.class_list = self._load_class_labels('/home/hackathon/frontend/coco_BT.txt') #lables 
        self.output_dir = "/home/frontend/output_OBJ"
